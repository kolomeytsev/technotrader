...
from rllib.tdagent.algorithms import crp, ons, olmar, up, anticor1, pamr, \
    best, bk, cwmr_std, eg, sp, ubah, wmamr, bcrp, cornk, m0, rmr, \
    trend_follow, hmm_trend_follow
...
ALGOS = {"crp": crp.CRP, "ons": ons.ONS, "olmar": olmar.OLMAR, "up": up.UP,
         ...
         "wmamr": wmamr.WMAMR,
         "trend_follow": trend_follow.TrendFollow, "hmm_trend_follow": hmm_trend_follow.HmmTrendFollow}
...
def execute_backtest(algo, config):
    ...
    return backtester.test_pc_vector, backtester.test_pc_vector_no_commission
