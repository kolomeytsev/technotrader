...
class RollingTrainer(TraderTrainer):
    def __init__(self, config, last_candles_params, restore_dir=None, save_path=None, 
                agent=None, device="cpu"):
        config["training"]["buffer_biased"] = config["trading"]["buffer_biased"]
        config["training"]["learning_rate"] = config["trading"]["learning_rate"]
        TraderTrainer.__init__(self, config, last_candles_params, restore_dir=restore_dir, save_path=save_path,
