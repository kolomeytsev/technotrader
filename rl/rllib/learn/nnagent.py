...
import rllib.learn.network as network
...
class NNAgent:
    ...
    def __set_loss_function(self):
        ...
        elif self.__config["training"]["loss_function"] == "loss_function_sharpe":
            loss_function = loss_function_sharpe
