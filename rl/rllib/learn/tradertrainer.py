...
from rllib.learn.nnagent import NNAgent
...
class TraderTrainer:
    def __init__(self, config, last_candles_params,
                fake_data=False, restore_dir=None, save_path=None, 
                device="cpu", agent=None):
        """
        :param config: config dictionary
        :param last_candles_params: parameters for getting data via last_candles function
                                    order: exchange_name, features, candles_res, relevant_columns
        ...
        self._matrix = DataMatrices.create_from_config(config, last_candles_params)
