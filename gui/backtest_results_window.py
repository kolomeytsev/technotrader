...
class Ui_FormPlot(object):
    def setupUi(self, FormPlot):
        ...
        self.groupBox = QtWidgets.QGroupBox(self.groupBoxPlotParameters)
        self.groupBox.setMinimumSize(QtCore.QSize(0, 50))
        self.groupBox.setObjectName("groupBox")
        self.horizontalLayout = QtWidgets.QHBoxLayout(self.groupBox)
        self.horizontalLayout.setContentsMargins(0, 0, 0, 0)
        self.horizontalLayout.setObjectName("horizontalLayout")
        self.pushButtonPlotUbah = QtWidgets.QPushButton(self.groupBox)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.horizontalLayout.addWidget(self.pushButtonPlotUbah)
        self.pushButtonPlotUcrp = QtWidgets.QPushButton(self.groupBox)
        self.pushButtonPlotUcrp.setObjectName("pushButtonPlotUcrp")
        self.horizontalLayout.addWidget(self.pushButtonPlotUcrp)
        self.formLayout_2.setWidget(9, QtWidgets.QFormLayout.SpanningRole, self.groupBox)
    ...
    def retranslateUi(self, FormPlot):
        ...
        self.groupBox.setTitle(_translate("FormPlot", "Baselines"))
