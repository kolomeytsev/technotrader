...
class Ui_FormPlot(object):
    def setupUi(self, FormPlot):
        ...
        self.formLayout_2.setWidget(5, QtWidgets.QFormLayout.LabelRole, self.labelLegend)
        self.comboBoxLegend = QtWidgets.QComboBox(self.groupBoxPlotParameters)
        self.comboBoxLegend.setObjectName("comboBoxLegend")
        self.formLayout_2.setWidget(5, QtWidgets.QFormLayout.FieldRole, self.comboBoxLegend)
        ...
        self.formLayout_2.setWidget(6, QtWidgets.QFormLayout.FieldRole, self.pushButtonPlot)
        ...
        self.formLayout_2.setWidget(6, QtWidgets.QFormLayout.LabelRole, self.pushButtonComputeMetrics)
